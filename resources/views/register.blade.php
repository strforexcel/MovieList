...
<body style="background-color: #252525">
    ...
    {{-- form --}}
        <div class="body-container" style="display: flex; justify-content: center; background-color: black; width: auto; height: 800px;">
            <div style="color: white">
                <h1>Hello, Welcome to <span style="color: red">Movie</span>List</h1>
            </div>
